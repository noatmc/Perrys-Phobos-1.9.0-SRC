...
class CrystalModifier
    ...
    public Setting < Float > scale = this.register ( new Setting < Float > ( "Scale" , 1.0f , 0.1f , 10.0f ) );
    public Setting < Float > lineWidth = this.register ( new Setting < Float > ( "LineWidth" , 1.0f , 0.1f , 3.0f ) );
