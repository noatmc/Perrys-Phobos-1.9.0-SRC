...
class HUD
    ...
    private final Setting < Boolean > arrayList = this.register ( new Setting < Boolean > ( "ActiveModules" , Boolean.FALSE , "Lists the active modules." ) );
    ...
    private final Setting < Boolean > serverBrand = this.register ( new Setting < Boolean > ( "ServerBrand" , Boolean.FALSE , "Brand of the server you are on." ) );
    ...
    private final Setting < Boolean > potions = this.register ( new Setting < Boolean > ( "Potions" , Boolean.FALSE , "Active potion effects" ) );
    ...
    private final Setting < Boolean > durability = this.register ( new Setting < Boolean > ( "Durability" , Boolean.FALSE , "Durability" ) );
    ...
    private final Setting < Boolean > queue = this.register ( new Setting < Boolean > ( "2b2tQueue" , Boolean.FALSE , "Shows the 2b2t queue." ) );
    ...
    public Setting < Boolean > colorSync = this.register ( new Setting < Boolean > ( "Sync" , Boolean.FALSE , "Universal colors for hud." ) );
    public Setting < Boolean > rainbow = this.register ( new Setting < Boolean > ( "Rainbow" , Boolean.FALSE , "Rainbow hud." ) );
    ...
    public Setting < Boolean > potionIcons = this.register ( new Setting < Boolean > ( "PotionIcons" , Boolean.TRUE , "Draws Potion Icons." ) );
    public Setting < Boolean > shadow = this.register ( new Setting < Boolean > ( "Shadow" , Boolean.FALSE , "Draws the text with a shadow." ) );
    ...
    public Setting < Boolean > textRadar = this.register ( new Setting < Boolean > ( "TextRadar" , Boolean.FALSE , "A TextRadar" ) );
