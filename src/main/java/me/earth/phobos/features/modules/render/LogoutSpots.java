...
class LogoutSpots
    ...
    private final Setting < Float > scaling = this.register ( new Setting < Float > ( "Size" , 4.0f , 0.1f , 20.0f ) );
    ...
    public Setting < Float > range = this.register ( new Setting < Float > ( "Range" , 300.0f , 50.0f , 500.0f ) );
