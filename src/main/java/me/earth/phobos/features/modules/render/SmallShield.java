...
class SmallShield
    ...
    public Setting < Float > mainX = this.register ( new Setting < Float > ( "MainX" , 0.0f , - 1.0f , 1.0f ) );
    public Setting < Float > mainY = this.register ( new Setting < Float > ( "MainY" , 0.0f , - 1.0f , 1.0f ) );
