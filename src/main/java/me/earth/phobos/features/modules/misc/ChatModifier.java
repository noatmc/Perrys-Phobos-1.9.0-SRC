...
class ChatModifier
    ...
    public Setting < Boolean > clean = this.register ( new Setting < Boolean > ( "CleanChat" , Boolean.FALSE , "Cleans your chat" ) );
    public Setting < Boolean > infinite = this.register ( new Setting < Boolean > ( "Infinite" , Boolean.FALSE , "Makes your chat infinite." ) );
    public Setting < Boolean > autoQMain = this.register ( new Setting < Boolean > ( "AutoQMain" , Boolean.FALSE , "Spams AutoQMain" ) );
